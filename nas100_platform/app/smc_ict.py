...
def evaluate_ict(
    ...
    if resolved is None:
        ...
        # what's forming. But if a reset is active and even this newest
        # trigger predates it, the zone/active flags are explicitly
        # cleared so nothing gets silently picked as the entry target;
        # the OB/FVG/breaker candidates themselves stay visible on the
        # chart either way.
