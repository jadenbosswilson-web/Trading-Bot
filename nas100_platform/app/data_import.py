...
Two options, in order of how much you should trust them:

1. `load_csv()` — the most reliable path. Export historical NAS100 (or
   whatever you're trading) candles from TradingView, your broker's
   platform, or anywhere else as a CSV and point the app at it. No
   credentials, no third-party API reliability risk.
2. `fetch_yahoo_history()` — a free, no-key "quick start" option using
   ...
   Futures prices also won't exactly match a broker's CFD quotes
