...
def get_signal(
    ...
    # Set by the dashboard's "Reset reversal" button (see smc_ict.py's
    # evaluate_ict docstring for reversal_reset_after) — every CHoCH at
    # or before this timestamp is ignored for reversal purposes only,
    # independent of checklist_reset_after above.
    ...
    result = smc_ict.evaluate_ict(
        ...
        reversal_reset_after=reversal_reset_after,
    )
